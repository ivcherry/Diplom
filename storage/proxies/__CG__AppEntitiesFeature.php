...
class Feature extends \App\Entities\Feature implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function addType(\App\Entities\Type $type)
    {
     ...
     * {@inheritDoc}
     */
    public function deleteType(\App\Entities\Type $type)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'deleteType', [$type]);
