    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'meta'          => 'fluent',
            'mappings'      =>[
                App\Mappings\ProductMap::class,
                App\Mappings\TypeMap::class,
                App\Mappings\GenericTypeMap::class,
                App\Mappings\UserMap::class,
                App\Mappings\RoleMap::class,
                App\Mappings\FeatureMap::class,
                App\Mappings\ReviewMap::class,
                App\Mappings\PhotoMap::class,
                App\Mappings\ProductFeatureMap::class,
                App\Mappings\ProductOrderMap::class,
                App\Mappings\OrderMap::class,
                App\Mappings\SaleMap::class,
                App\Mappings\NewsMap::class,
                App\Mappings\PageContentMap::class,
                App\Mappings\CompatibilityMap::class,
                App\Mappings\ScheduleMap::class,
                App\Mappings\WorkSchedulerMap::class
