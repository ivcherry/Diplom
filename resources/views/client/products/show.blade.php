    ...
    <div class="productBlock k-widget k-listview" id="productBlock">
        <div class="product">
            ...
            <div class='summary inline'>
                ...
                <p class='desc' style="font-size: 14px">{{ $product->getDescription() }}</p>
                <div>
                    <div class="addToCompareBlock">
                        @if($isInCompare)
                            <button class="btn btn-default btn-info"><a href="/compare">В сравнении</a></button>
                        @elseif(!($compareAllowed))
                            <button id='not-allowed' class="btn btn-default btn-info">Невозможно добавить</button>
                            <div id='not-allowed-notice' class='not-allowed-notice' style="display: none;"> очистите
                                свой список сравнения
                            </div>
                        @else
                    ...
                    <div class="addToCart">
                        @if($product->getAmount() > 0)
                            @if($isInCart)
                                <button class="btn btn-default btn-primary"><a href="/shoppingCart">В корзине</a>
                                </button>
                            @else
            ...
            <div class='info'>
                <div class="tab">
                    <button class="tablinks" onclick="openTab(event, 'Features')" id="defaultOpen"><h4>
                            Характеристики</h4></button>
