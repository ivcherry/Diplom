...
@section('content')
    <div class="admin container">
        ...
        <div class="model-buttons">
                <button id="add" class="main-buttons" type="button" data-toggle="modal" data-target="#addModal">Добавить</button>
                <button id="delete" class="main-buttons">Удалить</button>
                <button id="edit" class="main-buttonst" type="button" data-toggle="modal" data-target="#editModal">Изменить</button>
        </div>
